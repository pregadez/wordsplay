                    ...
                    <div class="mb-1">
                      <v-row justify="center">
                        <v-col cols="6" class="mr-0 pr-0">
                          <span><small>by</small></span> <span style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-size: large;font-stretch: wider;">praga</span><span style="color: grey;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;font-size: large;font-stretch: expanded;">S</span><span> & </span>
                        </v-col>
                    </v-row>  
                      <v-divider
                          :thickness="0.5"
                        ...
                        <span style="font-size: x-small;">
                          <v-btn
                            ...
                            color="dark"
                            icon="mdi-github"
                            href="https://github.com/pregadez/" 
                            target="_blank"
                          ></v-btn> |
                          <v-btn
                            size="small"
                            ...
                            color="dark"
                            icon="mdi-linkedin"
                            href="https://www.linkedin.com/in/pragadeesh-s-1749a622a/" 
                            target="_blank"
                          ></v-btn>
                        </span>
