...
func (r *RoomData) HandleRoomData(room sockit.Room, server sockit.MeshServer) {
...
// global room
func (r *RoomData) handleServermessages(room sockit.Room, server sockit.MeshServer, message *sockit.Message) {
...
func (r *RoomData) FailToJoinRoomNotify(reason string, clientsinroom []string, room sockit.Room, server sockit.MeshServer) {
	reasonmsg := ""
...
func (r *GameRoomData) FailToJoinRoomNotify(reason string, clientsinroom []string, room sockit.Room, server sockit.MeshServer) {
	reasonmsg := ""
	log.Println("Client removed", clientsinroom[2])
	if reason == "room-full" {
		reasonmsg = "Failed to join the room its occupied"
